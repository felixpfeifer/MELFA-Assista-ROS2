...
namespace melfa_assista_hardware
{
    ...
    protected:
        ...
        double tool_position_command_; // Variable for the tool position command
        double tool_velocity_state_;   // Variable for the tool velocity state
        double tool_position_state_;   // Variable for the tool position state
